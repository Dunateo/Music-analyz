...
public class OneEntry {
    ...
    public OneEntry(final int nbEntrees)
    {
...
// poids synaptiques ainsi que du biais en fonction de données supervisées
    ...
    public static void main(String[] args)
    {
        ...
        final float[][] entrees = {{765f,23}, {10.2f}, {8.5f}, {8f},{10.f}};

        // Tableau des sorties de la fonction ET
        final float[] resultats = {1, 1, 0, 0,0};
        final float[] resultats2 = {0, 0, 1, 1,0};

        // On crée un neurone taillé pour apprendre la fonction ET
        final OneEntry n = new OneEntry(1);
        final OneEntry n2 = new OneEntry(1);
        ...
        for (int i = 0; i < entrees.length; ++i)
        {
            ...
            if(n.sortie == 1){
                System.out.println("Entree" + i + " : " + notes.DO);
            }else {
        ...
        for (int i = 0; i < entrees.length; ++i)
        {
            ...
            // On affiche cette sortie
            if(n2.sortie == 1){
                System.out.println("Entree "+i+" : "+notes.LA);
            }else{
